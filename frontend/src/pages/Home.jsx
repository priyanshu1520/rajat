...
//     e.preventDefault();
//     // You can perform any action with the username here (e.g., fetch user data from Codeforces API).
//     console.log('Submitted username:', username);

//     // Update the URL with the entered username
...
//   return (
//     <div className='bg-sky-600 h-screen flex justify-center items-center'>
//       <div className='bg-white p-8 rounded-lg shadow-md'>
//         <h1 className='text-2xl font-semibold mb-4'>Cost of Your Codeforces Account</h1>
...
//           <button
//             type='submit'
//             className='bg-blue-500 text-white rounded-md mt-4 px-4 py-2 hover:bg-blue-600'
//           >
//             Get User Info
//           </button>
//         </form>
